...
const Step1 = () => {
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbzpbG1CcPH5y7BGW6cJ5r2VivimxL7EQl96RBx8Cp6qRj1MW7zm/exec" //Test URL https://docs.google.com/spreadsheets/d/1CoQ2ZOVJLT9U9OkgdEvxuX3vNg-wZwLjbOEYr0Ivfhc/edit#gid=0
  ...
  const [submitBut, setsubmitBut] = useState(false)
   const onSubmit = (data, e) => {
    ...
    // code below was commented out for testing purposes
          ...
          <div className="form-group">
            <div className="row">
              <div className="col-md-5">
                ...
                />
                {errors.firstName && (
                  <div className="form_error">First Name is required</div>
                )}
              </div>
              ...
              <div className="col">
                ...
                />
                {errors.lastName && (
                  <div className="form_error">Last Name is required</div>
                )}
              </div>
            </div>
          </div>
              ...
              <div className="col-md-5">
                ...
                <div className="radio-group">
                  <div className="form-check form-check-inline">
                    ...
                    />
                    <label className="form-check-label " htmlFor="insured-0">
                      {" "}
                  ...
                  <div className="form-check form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="insured-1">
                      {" "}
                      I'm NOT Insured
                    </label>
                  </div>
                ...
                {errors.insured && (
                  <div className="form_error">Insurance Status is required</div>
                )}
              </div>

              <div className="col">
                <label className="control-label" htmlFor="interest">
                  How can we help you?
                </label>
                <div className="radio-group">
                  <div className="form-check form-check-inline">
                    <input
                      className="form-check-input interest"
                      type="radio"
                      name="interest"
                      id="interest-0"
                      value="1"
                    ...
                    />
                    <label className="form-check-label" htmlFor="interest-0">
                  ...
                  <div className="form-check form-check-inline">
                    ...
                    />
                    <label
                      className="form-check-label interest"
                      htmlFor="interest-1"
                    >
                  ...
                  <div className="form-check form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="interest-2">
                  ...
                  <div className="form-check form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="interest-3">
                      I'm just curious.
                    </label>
                  </div>
                </div>
            ...
            <div className="row">
              ...
              <div className="col">
                ...
                {errors.contactMethod && (
                  <div className="form_error">
                    Please choose how you'd prefer to be contacted
                  </div>
                )}
              </div>
            </div>
